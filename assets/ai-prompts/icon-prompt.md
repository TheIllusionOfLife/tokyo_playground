...
Use this prompt with an image generation tool (DALL-E, Midjourney, etc.) to create the game icon.

---

## Requirements
- Size: 512x512 pixels (Roblox requirement)
- Must be readable at small sizes (50x50 on mobile home feed)
- No text (Roblox overlays the game name automatically)
- Bright, saturated colors that pop on the Roblox home page
...
1. Resize to exactly 512x512 if needed
2. Check readability at 50x50 (squint test)
3. Upload via Creator Hub > Game Settings > Basic Info > Icon
4. Roblox may take up to 24 hours to moderate and display

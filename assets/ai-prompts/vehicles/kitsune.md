...
## Part Requirements
- **Body** (PrimaryPart): Sleek elegant torso
- **Head**: Narrow face with amber eyes
- **Anim_LegFL/FR/BL/BR**: Slim athletic legs
- **Anim_EarL/R**: Large pointed ears, red tips
- **Anim_Tail**: Three tails fanning out, red tips
- **Anim_Snout**: Narrow elegant snout

## Colors
- Body: White (255, 255, 255) to pale cream
- Ear tips: Red (200, 40, 40)
- Tail tips: Red (200, 40, 40)
- Eyes: Amber/gold glow (255, 180, 30)

## Verify
- [ ] `ServerStorage.KitsuneTemplate` exists as Model

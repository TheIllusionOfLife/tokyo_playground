...
## Part Requirements
- **Body** (PrimaryPart): Round, chubby torso
- **Head**: Round face with dark eye patches, friendly expression
- **Anim_LegFL/FR/BL/BR**: Very short stubby legs
- **Anim_EarL/R**: Small round ears
- **Anim_Tail**: Large bushy striped tail
- **Leaf** (static, welded to Head): Green leaf on top of head

## Colors
- Body: Dark brown (100, 70, 40) with cream belly (220, 200, 160)
- Eye patches: Dark brown/black
- Leaf: Green (50, 180, 50)
- Tail: Brown with darker stripes

## Verify
- [ ] `ServerStorage.TanukiTemplate` exists as Model

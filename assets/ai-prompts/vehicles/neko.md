...
## Part Requirements
- **Body** (PrimaryPart): Oval torso, white with orange/black patches
- **Head**: Round, slightly oversized for cartoon style
- **Anim_LegFL/FR/BL/BR**: Short stubby legs
- **Anim_EarL/R**: Large triangular pointed ears
- **Anim_Tail**: Long curved tail, orange tip

## Colors
- Body: White (255, 255, 255) with orange (255, 140, 50) and black patches
- Ears: Pink inside, white outside
- Nose: Pink

## Verify
- [ ] `ServerStorage.NekoTemplate` exists as Model

...
| v0.26.0 | 2026-04-03 | Weekly leaderboard + minigame polish: weekly Hachi Ride high score tab (JST Monday reset), Hachi score offset fix, results screen sequencing, Hide & Seek rename + crowd/car removal + tagged spectating, Can Kick catch radius + jail + auto-kick fixes, UI overhaul (scoreboard, RewardPopup, intro overlay, SkillsPanel) |

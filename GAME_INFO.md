...
| Age Rating | All Ages |
| Genre | All Genres |
| Communication | Server Announcements |
...
## Key Features (for thumbnails / marketing)

- Real Shibuya streets built from 3D city data
...
City data: Project PLATEAU (Ministry of Land, Infrastructure, Transport and Tourism, Japan). CC BY 4.0.
